...
class VendasSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Vendas
        fields = ['cliente', 'estoque', 'nome_cliente','produto', 'quantidade','valor','total_venda']
...
class ComprasSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Compras
        fields = ['fornecedor', 'estoque', 'nome_fornecedor','produto', 'quantidade','valor','total_compra']
